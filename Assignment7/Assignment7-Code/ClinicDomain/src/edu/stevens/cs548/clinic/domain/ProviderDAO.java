...
public class ProviderDAO implements IProviderDAO {
	...
	public Provider getProviderByNPI(long npi) throws ProviderExn {
		//Query query = em.createNamedQuery("CountProviderByProviderNPI").setParameter("pid", npi);
		//Long numExisting = (Long) query.getSingleResult();
...
//		Query query = em.createNamedQuery("CountProviderByProviderID").setParameter("pid", id);
//		Long numExisting = (Long) query.getSingleResult();
