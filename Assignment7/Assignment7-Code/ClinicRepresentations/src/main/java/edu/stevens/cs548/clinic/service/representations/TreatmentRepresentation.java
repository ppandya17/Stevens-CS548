...
public class TreatmentRepresentation extends TreatmentType {
	...
	//final static Logger logger = Logger.getLogger(TreatmentRepresentation.class.getCanonicalName());
	...
	public TreatmentRepresentation (TreatmentDto dto, UriInfo uriInfo) {
		...
		if (dto.getDrugTreatment() != null) {
			...
			//logger.info("TREATMENT REPRESENTATION: SURGERY");
			...
			//logger.info("TREATMENT REPRESENTATION: RADIOLOGY");
