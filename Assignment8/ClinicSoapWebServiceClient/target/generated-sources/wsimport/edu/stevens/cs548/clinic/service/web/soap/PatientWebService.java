 ...
 * 
 */
@WebServiceClient(name = "PatientWebService", targetNamespace = "http://cs548.stevens.edu/clinic/service/web/soap", wsdlLocation = "file:/C:/Users/Gayatri/Desktop/Sem1/CS548/Assignments/Assignment8/code/ClinicSoapWebServiceClient/src/main/resources/PatientWebService.wsdl")
    ...
    extends Service
{
    ...
    private final static QName PATIENTWEBSERVICE_QNAME = new QName("http://cs548.stevens.edu/clinic/service/web/soap", "PatientWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/C:/Users/Gayatri/Desktop/Sem1/CS548/Assignments/Assignment8/code/ClinicSoapWebServiceClient/src/main/resources/PatientWebService.wsdl");
    ...
    public IPatientWebPort getPatientWebPort() {
        return super.getPort(new QName("http://cs548.stevens.edu/clinic/service/web/soap", "PatientWebPort"), IPatientWebPort.class);
    }
    ...
    public IPatientWebPort getPatientWebPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://cs548.stevens.edu/clinic/service/web/soap", "PatientWebPort"), IPatientWebPort.class, features);
    }
